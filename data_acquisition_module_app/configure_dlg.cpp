...

{
    ...
    UpdateData ( TRUE ) ;
      ...
      ptr_c -> serial_comm_port = atoi ( m_comm_port_string ) ;
      ...
      if ( strcmpi (  m_comm_port_string, "Comm5"  ) == 0 )  ptr_c -> serial_comm_port = 5  ;  
      if ( strcmpi (  m_comm_port_string, "Comm6"  ) == 0 )  ptr_c -> serial_comm_port = 6  ;
      if ( strcmpi (  m_comm_port_string, "Comm7"  ) == 0 )  ptr_c -> serial_comm_port = 7  ;
      if ( strcmpi (  m_comm_port_string, "Comm8"  ) == 0 )  ptr_c -> serial_comm_port = 8  ;

      if ( strcmpi (  m_comm_port_string, "Comm9"  ) == 0 )  ptr_c -> serial_comm_port = 9  ;  
      if ( strcmpi (  m_comm_port_string, "Comm10" ) == 0 )  ptr_c -> serial_comm_port =10  ;
      if ( strcmpi (  m_comm_port_string, "Comm11" ) == 0 )  ptr_c -> serial_comm_port =11  ;
      if ( strcmpi (  m_comm_port_string, "Comm12" ) == 0 )  ptr_c -> serial_comm_port =12  ;

      if ( strcmpi (  m_comm_port_string, "Comm13" ) == 0 )  ptr_c -> serial_comm_port =13  ;  
      if ( strcmpi (  m_comm_port_string, "Comm14" ) == 0 )  ptr_c -> serial_comm_port =14  ;
      if ( strcmpi (  m_comm_port_string, "Comm15" ) == 0 )  ptr_c -> serial_comm_port =15  ;
      if ( strcmpi (  m_comm_port_string, "Comm16" ) == 0 )  ptr_c -> serial_comm_port =16  ;
...

{
  ...
  #if ( RELEASE_DATE >= 0x090604 )
    sprintf ( scratch_string, "%d", ptr_c -> serial_comm_port ) ;
  #endif
